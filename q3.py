...
def summarize_words(filename: str) -> str:
    ...
    TODO: please finish this comment (args, returns, errors)
    """
    # 0. If the file is not found, raise a ValueError
    # 1. Read the enture file content
    # 2. Count the total words, sentences, and paragraphs
